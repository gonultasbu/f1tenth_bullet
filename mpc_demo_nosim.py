...
import sys
from waypoint_creation import create_waypoints, compute_path
...
class MPCSim:
    def __init__(self):
        ...
        Q = [30, 30, 10, 10]  # state error cost
        Qf = [30, 30, 30, 30]  # state final error cost
        R = [10, 20]  # input cost
        P = [20, 10]  # input rate of change cost
        ...
        self.path = compute_path(waypoints)
